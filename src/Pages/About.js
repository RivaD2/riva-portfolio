    ...
    return (
      <div className="about-container">
        <div className="headshot-container">
          <header className="svg-about">
            <SvgHeader />
          </header>
          <img src="/images/riva.jpg" alt="headshot showing the creator of this site, Riva Davidowski" className="profile-image"/>
        </div>
        <div className="text-container">
          ...
          <p className="hobby-text"><b>In my free time you can find me:</b></p>
          <br/>
          <ul>
